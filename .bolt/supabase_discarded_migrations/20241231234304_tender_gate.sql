...
VALUES 
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'alex.thompson@email.com', current_timestamp)
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'Alex Thompson', 'brown', 1, 'active')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'member')
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'Emma Thompson', 'Sister', '555-0125', true);
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', ARRAY['None'], ARRAY['None'], ARRAY['None'], 'B+');
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'Unlimited', current_timestamp - interval '3 months', current_timestamp + interval '9 months', 'active', 'monthly', 150.00);
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'brown', 1, 'd0d8d9e2-0e13-4c0c-9e54-5d5b6d60d1d0', 'Outstanding technical development');
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'Open Mat', 'd0d8d9e2-0e13-4c0c-9e54-5d5b6d60d1d0');
...
VALUES
  ...
  ('6b7c8d9e-3f2e-4a5b-8c7d-8e9f0a1b2c3d', 'Liability', current_timestamp, current_timestamp + interval '1 year');